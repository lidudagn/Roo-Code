	...
	return {
		...
		resolve: {
			alias: {
				...
				// FIXED: Direct Vite to the mock file for vscode to prevent resolution errors
		...
		optimizeDeps: {
			...
			// FIXED: Explicitly exclude vscode from pre-bundling to avoid the search/resolve error
